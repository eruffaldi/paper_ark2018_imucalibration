...
luaL = hparamsL(1,1);
lfaL = hparamsL(1,2);
xL = [hparamsL(2,4:6); hparamsL(3,4:6)];
pL = [hparamsL(2,7:9); hparamsL(3,7:9)];

luaR = hparamsR(1,1);
lfaR = hparamsR(1,2);
xR = [hparamsR(2,4:6); hparamsR(3,4:6)];
pR = [hparamsR(2,7:9); hparamsR(3,7:9)];
...
%     DHRs = thR.DHall(qsR(i,:));
    [TL,SL] = modDHL(qsL(i,:), luaL, lfaL, xL(2,:), pL(2,:));
    [TR,SR] = modDHR(qsR(i,:), luaR, lfaR, xR(2,:), pR(2,:));
    
    
    TS02L = TL(1:4,1:4)*TL(1:4,5:8)*TL(1:4,9:12)*TL(1:4,13:16)*SL;
    TS02R = TR(1:4,1:4)*TR(1:4,5:8)*TR(1:4,9:12)*TR(1:4,13:16)*SR;
%     
...
P2K5Lof(1,:) = P2K5Lof(1,:) - repmat((P2K5Lof(1,1) - Ps2L_s(1,1)),1,sL);
P2K5Lof(2,:) = P2K5Lof(2,:) - repmat((P2K5Lof(2,1) - Ps2L_s(1,2)),1,sL);
P2K5Lof(3,:) = P2K5Lof(3,:) - repmat((P2K5Lof(3,1) - Ps2L_s(1,3)),1,sL);
P2K5Rof(1,:) = P2K5Rof(1,:) - repmat((P2K5Rof(1,1) - Ps2R_s(1,1)),1,sR);
P2K5Rof(2,:) = P2K5Rof(2,:) - repmat((P2K5Rof(2,1) - Ps2R_s(1,2)),1,sR);
P2K5Rof(3,:) = P2K5Rof(3,:) - repmat((P2K5Rof(3,1) - Ps2R_s(1,3)),1,sR);
